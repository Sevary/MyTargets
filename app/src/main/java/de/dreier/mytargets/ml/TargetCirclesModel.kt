...
import de.dreier.mytargets.ml.TargetCircles

class TargetCirclesModel(context: Context) {
    private val model: TargetCircles = TargetCircles.newInstance(context)
    ...
    fun process(bitmap: Bitmap): List<Detection> {
        ...
        for (i in 0 until num) {
            ...
            detections.add(Detection(score, rect, cls, null, null))
        }
